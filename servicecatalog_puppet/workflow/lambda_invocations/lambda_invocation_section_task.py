...
class LambdaInvocationsSectionTask(generic_section_task.GenericSectionTask):
    ...
    for_region_task_klass = lambda_invocation_for_region_task.LambdaInvocationForRegionTask
    for_account_task_klass = lambda_invocation_for_account_task.LambdaInvocationForAccountTask
