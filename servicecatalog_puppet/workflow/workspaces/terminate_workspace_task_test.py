...
class TerminateWorkspaceTaskTest(tasks_unit_tests_helper.PuppetTaskUnitTest):
    ...
    def setUp(self) -> None:
        ...
        self.module = terminate_workspace_task

        self.sut = self.module.TerminateWorkspaceTask(
