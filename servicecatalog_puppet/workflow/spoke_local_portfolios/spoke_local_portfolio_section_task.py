...
class SpokeLocalPortfolioSectionTask(generic_section_task.GenericSectionTask):
    ...
    for_region_task_klass = spoke_local_portfolio_for_region_task.SpokeLocalPortfolioForRegionTask
    for_account_task_klass = spoke_local_portfolio_for_account_task.SpokeLocalPortfolioForAccountTask
    for_account_and_region_task_klass = spoke_local_portfolio_for_account_and_region_task.SpokeLocalPortfolioForAccountAndRegionTask
