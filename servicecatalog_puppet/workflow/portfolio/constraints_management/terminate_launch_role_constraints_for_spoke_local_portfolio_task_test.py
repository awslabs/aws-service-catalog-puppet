...
class TerminateLaunchRoleConstraintsForSpokeLocalPortfolioTaskTest(tasks_unit_tests_helper.PuppetTaskUnitTest):
    ...
    def setUp(self) -> None:
        from servicecatalog_puppet.workflow.portfolio.constraints_management import terminate_launch_role_constraints_for_spoke_local_portfolio_task
