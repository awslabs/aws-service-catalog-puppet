    ...
    def setUp(self) -> None:
        ...
        self.sut = self.module.ImportIntoSpokeLocalPortfolioTask(
            **self.get_common_args(),
            account_id=self.account_id, region=self.region, portfolio_task_reference=self.portfolio_task_reference, hub_portfolio_task_reference=self.hub_portfolio_task_reference, portfolio_get_all_products_and_their_versions_ref=self.portfolio_get_all_products_and_their_versions_ref, portfolio_get_all_products_and_their_versions_for_hub_ref=self.portfolio_get_all_products_and_their_versions_for_hub_ref        
        )
