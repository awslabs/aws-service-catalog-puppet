...
class ExecuteSimulatePolicyTaskTest(tasks_unit_tests_helper.PuppetTaskUnitTest):
    ...
    def setUp(self) -> None:
        ...
        self.module = execute_simulate_policy_task

        self.sut = self.module.ExecuteSimulatePolicyTask(
