...
class ServiceControlPoliciesForAccountTaskTest(
    ...
    def setUp(self) -> None:
        ...
        self.module = service_control_policies_for_account_task

        self.sut = self.module.ServiceControlPoliciesForAccountTask(
