...
def test_get_next_tasks_to_run_for_task_with_no_deps():
    ...
    # exercise
    actual_result = sut.get_next_tasks_to_run_for_task(task_to_maybe_run, tasks_in_order, tasks_to_run,
                                                       resources_in_use)
...
def test_get_next_task_to_run_with_no_deps():
    ...
    # exercise
    actual_result = sut.get_next_task_to_run(tasks_in_order, tasks_to_run, resources_in_use).get("task_reference")
