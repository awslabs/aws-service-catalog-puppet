...
from servicecatalog_puppet.commands.task_reference_helpers.generators import launches, \
    spoke_local_portfolios, workspaces, \
    stacks, service_control_policies, \
    tag_policies, organizational_units


def generate(all_tasks, all_tasks_task_reference, item_name, puppet_account_id, section_name, task_reference,
             task_to_add):
