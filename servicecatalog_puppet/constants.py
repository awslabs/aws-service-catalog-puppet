...
IMPORTED_PORTFOLIOS = "imported-portfolios"
...
ALL_SECTION_NAME_SINGULAR_AND_PLURAL_LIST = [
    ...
    (IMPORTED_PORTFOLIO, IMPORTED_PORTFOLIOS),
...
DEPLOY_TO_NAMES = {
    ...
    IMPORTED_PORTFOLIOS: "share_with",
...
CACHE_LEVEL_PERMANENT = "CACHE_LEVEL_PERMANENT"
CACHE_LEVEL_NO_CACHE = "CACHE_LEVEL_NO_CACHE"
